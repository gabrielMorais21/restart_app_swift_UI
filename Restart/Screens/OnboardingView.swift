...
//  Restart
//
//  Created by Gabriel Morais Dias on 10/07/23.
//
            ...
            VStack (spacing:20){
                ...
                VStack(spacing: 0){
                    Text(textTitle)
                        ...
                        .transition(.opacity).id(textTitle)
                ...
                ZStack{
                    CircleGroupView(ShapeColor: .white, ShapeOpacity: 0.2)
                        ...
                        .blur(radius: abs(imageOffset.width / 5)).animation(.easeOut(duration: 1), value: imageOffset)
                    Image("character-1")
                        .resizable()
                        .scaledToFit()
                ...
                .frame(width: buttonWidth,height: 80, alignment: .center).padding().opacity(isAnimating ? 1 : 0).offset(y:isAnimating ? 0 : 40).animation(.easeOut(duration: 1), value: isAnimating)
            }
        }.onAppear(perform: {
            isAnimating = true
        })
